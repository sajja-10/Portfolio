...
// Function to activate the 'About' page as the default on page load
...
activateDefaultPage(); // Call the function to set 'About' as the default page
...
for (let i = 0; i < navigationLinks.length; i++) {
    navigationLinks[i].addEventListener("click", function (event) {
        ...
        history.pushState({ page: link }, null, `${window.location.origin}/${link}`);
